...
def placeholder_inputs(batch_size):
    ...
    building code and will be fed from the downloaded data in the
    .run() loop, below.

    Args:
        batch_size: The batch sie will be baked into both
        placeholder
    ...
    # Note that the shapes of the placeholders match the shapes of the
    # full image and label tensors, except the first dimensions is
    # now batch_size rather than the full size of the train or test
    # data Sets
    ...
    with tf.Graph().as_default():
        ...
        for step in xrange(FLAGS.max_steps):
            ...
            if step % 100 == 0:
                ...
                print('Step %d: loss = %.2f (%.3f)' % (step, loss_value, duration))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input_data_dir',
        type = str,
        default = '/tensorflow101/input_data',
        help = 'Directory to put the input data.'
    )
    parser.add_argument(
        '--log_dir',
        type=str,
        default='/tensorflow/logs/fully_connected_feed',
